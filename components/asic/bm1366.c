...
void BM1366_set_nonce_percent(uint64_t frequency, uint16_t chain_chip_count, int versions_to_roll, float nonce_percent) {
    ...
    int hcn = calculate_version_rolling_hcn(ASIC_BM1366.core_count,address_interval,cno_interval,frequency,nonce_percent);
...
float BM1366_get_timeout(uint64_t frequency, uint16_t chain_chip_count, int versions_to_roll, float nonce_percent, float timeout_percent) {
    ...
    float timeout_ms = calculate_timeout_ms(ASIC_BM1366.core_count,address_interval,(int)frequency,cno_interval,nonce_percent,timeout_percent,versions_per_core);
